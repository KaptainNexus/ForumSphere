...
ALTER TABLE Post ADD CONSTRAINT FK_Post_User FOREIGN KEY (user_id) REFERENCES "users"(user_id);
...
ALTER TABLE Comment ADD CONSTRAINT FK_Comment_User FOREIGN KEY (user_id) REFERENCES "users"(user_id);

-- Add foreign key constraints to Image table
ALTER TABLE Image ADD CONSTRAINT FK_Image_User FOREIGN KEY (user_id) REFERENCES "users"(user_id);

-- Add foreign key constraints to Reaction table
ALTER TABLE Reaction ADD CONSTRAINT FK_Reaction_User FOREIGN KEY (user_id) REFERENCES "users"(user_id);
...
ALTER TABLE Friendship ADD CONSTRAINT FK_Friendship_User_One FOREIGN KEY (user_id_one) REFERENCES "users"(user_id);
ALTER TABLE Friendship ADD CONSTRAINT FK_Friendship_User_Two FOREIGN KEY (user_id_two) REFERENCES "users"(user_id);

-- Add a column to the User table for password reset
ALTER TABLE "users" ADD COLUMN want_to_change_password BOOLEAN NOT NULL DEFAULT FALSE;
